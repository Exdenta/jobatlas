...
Use [the normalized YC Actor](https://apify.com/jobatlas/ycombinator-enrich-translate-normalize-scraper) for
...
curl --fail-with-body -X POST \
  'https://api.apify.com/v2/acts/jobatlas~ycombinator-enrich-translate-normalize-scraper/runs?build=latest&maxTotalChargeUsd=0.05&timeout=600&memory=512' \
