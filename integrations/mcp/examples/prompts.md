...
jobatlas/linkedin-enrich-translate-normalize-scraper at build selector latest.
...
```text
Use generic call-actor for
jobatlas/euraxess-enrich-translate-normalize-scraper at build selector latest.
